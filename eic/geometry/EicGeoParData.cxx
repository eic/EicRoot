...
{ 
  ...
  mRootGeoManager = 0; mWrapperVolume = mTopVolume = 0; 
...
const TGeoMedium *EicGeoParData::GetMedium(const char *medium) 
{
  ...
  if (!mMediaCache.count(medium))
  {
    ...
    TGeoMaterial *matAl = new TGeoMaterial(medium, 26.98, 13, 2.7);
    //   //--- define some media
    //TGeoMedium *Vacuum = new TGeoMedium("Vacuum",1, matVacuum);
    /*TGeoMedium *Al =*/ new TGeoMedium(medium, 2, matAl);
...
void EicGeoParData::FinalizeOutput() 
{  
