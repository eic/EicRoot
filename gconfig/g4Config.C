...
/// character: eg. stepLimit+specialCuts.
   ...
   TG4RunConfiguration* runConfiguration 
     ...
     //= new TG4RunConfiguration("geomRootToGeant4", "emStandard", "stepLimiter+specialCuts+specialControls");
     //= new TG4RunConfiguration("geomRoot", "emStandard", "stepLimiter");
     = new TG4RunConfiguration("geomRoot", "FTFP_BERT", "stepLimiter");
     //= new TG4RunConfiguration("geomRoot", "emStandard", "stepLimiter+specialControls");
     // In case want to activate SetCuts.C ...;
     //= new TG4RunConfiguration("geomRoot", "emStandard", "stepLimiter+specialCuts");
