...
#  MESSAGE("BLA: ${bla}")
  ...
  if (CMAKE_SYSTEM_NAME MATCHES Linux)
    ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILES}
       COMMAND LD_LIBRARY_PATH=${ROOT_LIBRARY_DIR}:${_intel_lib_dirs}:$ENV{LD_LIBRARY_PATH} ROOTSYS=${ROOTSYS} ${ROOT_CINT_EXECUTABLE}
...
#  Message("RuleName: ${RuleName}")
  ...
  set(rDictName ${CMAKE_CURRENT_BINARY_DIR}/G__${Int_LIB}Dict_rdict.pcm)
  ...
  ############### install the library ###################
  #install(TARGETS ${Int_LIB} ${rDictName} DESTINATION lib)
  #message( ${Int_LIB})
  #message( ${rDictName})
  install(TARGETS ${Int_LIB} DESTINATION lib)
  #message(${CMAKE_CURRENT_BINARY_DIR})
  message(${rDictName})
  file(GLOB RDICT "${rDictName}")	
  INSTALL(FILES ${RDICT} DESTINATION lib)
