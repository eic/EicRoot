// $Id: g4libs.C,v 1.1 2003/12/11 17:02:21 kasahara Exp $
//
...
// ---
  ...
  // AYK, 2013/05/12 g4libs_granular();
  g4libs_global();
}   
...
// ---
  ...
  cout << "Loading Geant4 global libraries ..." << endl;
   ...
   // CLHEP
  // AYK gSystem->Load("$(CLHEP_BASE_DIR)/lib/libCLHEP");
  ...
  gSystem->Load("libG4tracking");
  // AYK gSystem->Load("libG4digits+hits");
  gSystem->Load("libG4event");
  gSystem->Load("libG4readout");
  gSystem->Load("libG4run");
  gSystem->Load("libG3toG4");
  ...
  // geant4 VMC
  // AYK gSystem->Load("libroottog4");
  // AYK gSystem->Load("libg4toxml");
  gSystem->Load("libgeant4vmc");
