...
public:
  ...
  virtual GFAbsRecoHit* produce(int index, void *ptr = 0) = 0;
...
class GFRecoHitProducer : public GFAbsRecoHitProducer {
 ...
 public:
   ...
   * in TClonesArray
   */
  virtual GFAbsRecoHit* produce(int index, void *ptr = 0);	
};
/** @} */
...
template <class hit_T,class recoHit_T>
  GFAbsRecoHit* GFRecoHitProducer<hit_T,recoHit_T>::produce(int index, void *ptr) {
  ...
  return ( new recoHit_T( (hit_T*) hitArrayTClones->At(index), ptr) );
  //}
