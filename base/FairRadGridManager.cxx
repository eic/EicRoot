    ...
    TLorentzVector& mom )
{
  ...
  // AYK, 2016/07/13 -> need to make Mac OS X compiler happy (silent); this is indeed 
  // a bug, so prefer to assert(0) here just in case somebody ever wants to use this 
  // code under EicRoot;
  assert(0);
}
