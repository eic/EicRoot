...
void eventDisplay()
{
  ...
  fMan->AddTask(new FairMCPointDraw ("FemcMoCaPoint", kRed,   kFullSquare));
  fMan->AddTask(new FairMCPointDraw ("BemcMoCaPoint", kRed,   kFullSquare));
  fMan->AddTask(new FairMCPointDraw ("CemcMoCaPoint", kRed,   kFullSquare));
#endif
